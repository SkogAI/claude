...
```
UI_PHASE_FLAG=$(node "/home/skogix/claude/.claude/get-shit-done/bin/gsd-tools.cjs" config-get workflow.ui_phase --raw 2>/dev/null || echo "true")
...
```bash
CHECKPOINT=$(node "/home/skogix/claude/.claude/get-shit-done/bin/gsd-tools.cjs" uat render-checkpoint --file "$uat_path" --raw)
...
Read and follow `/home/skogix/claude/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/home/skogix/claude/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
