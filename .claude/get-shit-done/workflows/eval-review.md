...
```bash
AUDITOR_MODEL=$(node "/home/skogix/claude/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /home/skogix/claude/.claude/agents/gsd-eval-auditor.md for instructions.
