...
<required_reading>
@/home/skogix/claude/.claude/get-shit-done/references/domain-probes.md
@/home/skogix/claude/.claude/get-shit-done/references/gate-prompts.md
@/home/skogix/claude/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
AGENT_SKILLS_ADVISOR=$(node "/home/skogix/claude/.claude/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-advisor 2>/dev/null)
```
...
- Read and execute @/home/skogix/claude/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "/home/skogix/claude/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
```bash
MAX_PASSES=$(node "/home/skogix/claude/.claude/get-shit-done/bin/gsd-tools.cjs" config-get workflow.max_discuss_passes 2>/dev/null || echo "3")
```
...
**Full step-by-step instructions:** @/home/skogix/claude/.claude/get-shit-done/workflows/discuss-phase-power.md
