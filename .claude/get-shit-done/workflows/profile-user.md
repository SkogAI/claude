...
```bash
cp "/home/skogix/claude/.claude/get-shit-done/USER-PROFILE.md" "/home/skogix/claude/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/home/skogix/claude/.claude/USER-PROFILE.backup.md"
```
