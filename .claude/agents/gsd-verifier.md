...
<required_reading>
@/home/skogix/claude/.claude/get-shit-done/references/verification-overrides.md
...
@/home/skogix/claude/.claude/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/home/skogix/claude/.claude/get-shit-done/references/few-shot-examples/verifier.md
...
```bash
ROADMAP_DATA=$(node "/home/skogix/claude/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap analyze --raw)
```
