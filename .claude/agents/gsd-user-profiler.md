...
<reference>
@/home/skogix/claude/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/skogix/claude/.claude/get-shit-done/references/user-profiling.md` to load:
