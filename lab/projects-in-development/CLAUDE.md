...
<environment>
DEV_BASE_DIR=/home/skogix/dev/    # Base directory for cloned repositories
...
- Cloned to /home/skogix/dev/<repo-name>/
- Tracked in gita group "repos"
- Worktrees created in <repo>/.worktrees/<branch>/ using wt

Example worktree workflow (manual for now): cd /home/skogix/dev/<repo> wt switch --create feature-branch # Creates .worktrees/feature-branch/ wt remove # Removes worktree, switches back to main </workflow>
...
Note: Claude Code doesn't persist directory changes across Bash calls, so directory switching commands need special handling (print path for eval, or document manual workflow).
Note 2: Skogix; I do believe this is fixed by now.
<next_steps>
