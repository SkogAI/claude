...
Usage:
    ./scripts/utils/migrate-journals.py           # Dry run (shows what would happen)
    ./scripts/utils/migrate-journals.py --execute # Actually perform migration
"""
...
def main() -> int:
    ...
    if dry_run and migrated > 0:
        ...
        print("  ./scripts/utils/migrate-journals.py --execute")
