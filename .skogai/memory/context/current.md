...
title: current
type: note
permalink: claude/projects/dot-skogai/memory/context/current
---
...
- ✓ Established SKOGAI.md documentation pattern with XML-style tags
...
1. Local exclude: `.git/info/exclude` contains `.skogai`
