...
type: note
permalink: claude/projects/dot-skogai/knowledge/patterns/style/file-structure
---
...
1. `<execution_context>` - @-references to workflows, templates, references
1. `<context>` - dynamic content: `$arguments`, bash output, @file refs
1. `<process>` or `<step>` elements - implementation steps
1. `<success_criteria>` - measurable completion checklist
