...
title: CLAUDE
type: note
permalink: claude/tmp/system/claude
---
...
1. Check `SKOGAI.md` to understand what's currently configured
1. Check `TODO.md` for pending work
1. After making changes, update `SKOGAI.md` with new facts and check off completed items in `TODO.md`
1. Log non-obvious decisions in `DECISIONS.md` with reasoning
