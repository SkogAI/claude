...
title: catchup
type: note
permalink: claude/tmp/dot-claude/commands/catchup
---
...
1. [commit message 2] - [files affected] ...
...
1. **Use with Memory Bank**: Combine with `.claude/memory/` files for persistent state
1. **Branch naming**: Use descriptive branch names (e.g., `feat/user-auth`) to aid context restoration
