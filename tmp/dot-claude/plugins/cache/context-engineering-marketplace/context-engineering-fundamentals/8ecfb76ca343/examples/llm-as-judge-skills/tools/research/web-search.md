...
title: web-search
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/tools/research/web-search
---
...
1. **Quotes**: Use quotes for exact phrases
1. **Operators**: Support site:, -term, OR
1. **Context**: Include relevant context terms
1. **Recency**: Add year for recent info

## Implementation Notes

1. **Rate Limiting**: Implement appropriate rate limits
1. **Caching**: Cache results for repeated queries
1. **Result Quality**: Filter out low-quality sources
1. **Error Handling**: Handle API failures gracefully
1. **Privacy**: Log queries appropriately
