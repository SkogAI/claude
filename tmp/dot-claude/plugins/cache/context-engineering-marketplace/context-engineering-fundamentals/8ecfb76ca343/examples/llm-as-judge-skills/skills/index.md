...
title: index
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/skills/index
---
...
1. Create main file: `skills/<skill-name>/<skill-name>.md`
1. Include:
