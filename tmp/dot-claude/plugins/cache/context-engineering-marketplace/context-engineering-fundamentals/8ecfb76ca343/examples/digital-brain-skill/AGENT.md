...
title: AGENT
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/digital-brain-skill/agent
---
...
1. **Append to JSONL files, never overwrite** - Preserve history
1. **Update timestamps** when modifying tracked data
1. **Cross-reference modules** - Knowledge informs content, network informs operations
