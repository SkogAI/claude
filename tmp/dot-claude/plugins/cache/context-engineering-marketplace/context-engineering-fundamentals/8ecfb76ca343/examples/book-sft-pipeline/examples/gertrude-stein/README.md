...
title: README
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/book-sft-pipeline/examples/gertrude-stein/readme
---
...
1. **Simple vocabulary**: Common words, no ornate language
1. **Comma-separated adjectives**: "a dark, sweet, little, pretty girl"
1. **Present continuous tense**: "She was always doing", "He was thinking"
1. **Character focus**: Deep psychological observation over plot
1. **Rhythmic, hypnotic quality**: Almost musical prose
...
1. **Prompt diversity is critical**: 15 templates × 5 system prompts = 75 variations prevented memorization

1. **Base models over instruct**: Qwen3-8B-Base was more malleable than instruct versions

1. **Modern scenario testing proves transfer**: If style applies to modern contexts, the model learned patterns, not content

1. **~$2 is enough**: LLM calls for instruction generation (~$0.50) plus Tinker training (~$1.50)
