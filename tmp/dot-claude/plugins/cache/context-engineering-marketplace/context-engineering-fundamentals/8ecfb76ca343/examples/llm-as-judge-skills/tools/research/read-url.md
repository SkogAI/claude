...
title: read-url
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/tools/research/read-url
---
...
1. **Rate Limiting**: Don't hammer the same domain
1. **User Agent**: Use appropriate user agent string
1. **Timeouts**: Set reasonable timeouts (10-30s)
1. **JavaScript Rendering**: Consider headless browser for JS-heavy sites
1. **Caching**: Cache content for repeated reads
