...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/digital-brain-skill/examples/content-workflow
---
...
1. Rewrites point 3 with fear angle
1. Maintains thread flow
...
1. **Progressive Loading**: Only relevant modules accessed
1. **Pattern Matching**: Past success informs new content
1. **Full Pipeline**: Idea → Draft → Publish → Log
1. **Append-Only**: Ideas and posts logged, never deleted
