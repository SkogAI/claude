...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/book-sft-pipeline/references/segmentation-strategies
---
...
1. **Dialogue-heavy sections**: Short exchanges that individually are too small
1. **Scene boundaries**: Natural break points that don't align with word counts
1. **Stylistic variations**: Authors shift voice between narrative, dialogue, and exposition
