...
title: direct-score
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/tools/evaluation/direct-score
---
...
1. **Calibration**: Include few-shot examples of scores at each level
1. **Justification First**: Ask for justification before score to reduce bias
1. **Length Normalization**: Consider response length when appropriate
