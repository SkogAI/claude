...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/tools/evaluation/pairwise-compare
---
...
1. **Criteria Order**: Order criteria by importance for better focus
1. **Tie Handling**: Consider domain - some tasks should rarely tie
1. **Confidence Calibration**: Lower confidence when evaluations are close
1. **Length Considerations**: Note if one response is significantly longer
