...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/tools/evaluation/generate-rubric
---
...
1. **Boundary Clarity**: Clear distinctions between adjacent scores
1. **Example Quality**: Examples should be realistic, not strawmen
1. **Edge Case Coverage**: Anticipate common ambiguous situations
1. **Calibration**: Test rubric against known samples before use
