...
title: tinker-format
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/book-sft-pipeline/references/tinker-format
---
...
1. **Sequence Length**: Keep chunks under 1000 tokens. Longer sequences dilute local style patterns.

1. **Learning Rate**: Use 2x multiplier (e.g., 2e-4 instead of 1e-4) for faster style convergence.

1. **Token Alignment**: Target tokens must be shifted by 1 position from input tokens.

1. **Weight Precision**: Weights should be float32, typically 0.0 or 1.0.
