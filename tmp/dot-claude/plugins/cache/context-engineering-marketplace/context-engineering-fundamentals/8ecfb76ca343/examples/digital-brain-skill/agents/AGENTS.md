...
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/digital-brain-skill/agents/agents
---
...
1. **Content ideas**: Use when user asks for ideas, leverages knowledge base
1. **Stale contacts**: Run weekly, surfaces relationships needing attention
1. **Metrics snapshot**: Run weekly to append to metrics.jsonl
1. **Idea to draft**: Use when user wants to develop a specific idea
...
1. Follow existing patterns (read JSONL, output structured data)
