...
title: README
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/x-to-book-system/readme
---
...
1. Written to file system (not passed through context)
1. Read by Analyzer in chunks
1. Summarized before reaching Synthesizer
...
1. **Select architecture pattern**: Based on coordination needs, choose supervisor, swarm, or hierarchical
1. **Design memory system**: Based on query patterns, choose vector store, knowledge graph, or temporal graph
1. **Apply optimization techniques**: Observation masking, compaction, progressive disclosure as needed
1. **Build evaluation framework**: Define dimensions relevant to your use case
