---
title: HOW-SKILLS-BUILT-THIS
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/digital-brain-skill/how-skills-built-this
---
...
1. **New Script**: Tool Design (consolidation principle)
1. **New Template**: Evaluation (outcome-focused)
1. **New Data File**: Memory Systems (appropriate layer)
