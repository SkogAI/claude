...
title: README
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/readme
---
...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![TypeScript](https://img.shields.io/badge/TypeScript-5.6-blue.svg)](https://www.typescriptlang.org/) [![AI SDK](https://img.shields.io/badge/AI%20SDK-4.1-green.svg)](https://sdk.vercel.ai/) [![Tests](https://img.shields.io/badge/Tests-19%20passed-brightgreen.svg)](#test-results)
...
1. **Tool Design**: Best practices for building AI tools with proper schemas and error handling
1. **Evaluation Patterns**: Implementation of LLM-as-a-Judge patterns for quality assessment
...
1. **Context Engineering**: Applies context fundamentals in evaluation prompts
1. **Tool Design Patterns**: Implements Zod schemas, error handling, and clear interfaces
1. **Agent Architecture**: Uses AI SDK patterns for agent abstraction
...
1. Implement execute function
1. Export from `src/tools/<category>/index.ts`
