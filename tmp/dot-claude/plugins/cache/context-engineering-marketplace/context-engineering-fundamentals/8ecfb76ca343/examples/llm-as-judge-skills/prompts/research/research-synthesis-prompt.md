...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/prompts/research/research-synthesis-prompt
---
...
1. **Weight by Quality**: Academic sources > blogs for factual claims
1. **Recency Matters**: Note when findings may be outdated
1. **Acknowledge Gaps**: Don't overstate what sources support
1. **Actionable Output**: End with practical takeaways
