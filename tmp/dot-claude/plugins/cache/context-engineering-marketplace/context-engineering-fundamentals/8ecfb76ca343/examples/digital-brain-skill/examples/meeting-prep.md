...
title: meeting-prep
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/digital-brain-skill/examples/meeting-prep
---
...
1. **Actionable Output**: Brief highlights what to discuss
1. **Follow-up Tracking**: Pending items surfaced proactively
1. **Complete Loop**: Meeting → Log → Update todos → Update contact
1. **Relationship Intelligence**: Notes inform meeting approach
