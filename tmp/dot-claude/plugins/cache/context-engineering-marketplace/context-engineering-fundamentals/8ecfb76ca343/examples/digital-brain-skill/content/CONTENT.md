...
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/digital-brain-skill/content/content
---
...
1. Check `calendar.md` - plan next week
1. Review `posts.jsonl` - analyze what worked
1. Update `engagement.jsonl` - save inspiring content
...
1. **Creating drafts**: Use templates from templates/ as starting points
1. **Writing content**: MUST read identity/voice.md first
1. **Publishing**: Log to posts.jsonl with all metadata
1. **Analysis**: Reference posts.jsonl for performance patterns
