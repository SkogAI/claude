...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/tools/orchestration/delegate-to-agent
---
...
1. **Timeout Handling**: Set realistic timeouts per agent type
1. **Retry Logic**: Implement retries for transient failures
1. **Audit Trail**: Log all delegations for traceability
1. **Resource Management**: Track token usage across delegations
