...
title: index
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/tools/index
---
...
1. Create tool file: `tools/<category>/<tool-name>.md`
1. Define:
