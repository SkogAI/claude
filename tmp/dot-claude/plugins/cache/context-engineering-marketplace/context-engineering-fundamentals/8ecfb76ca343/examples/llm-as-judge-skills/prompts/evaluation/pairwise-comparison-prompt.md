...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/prompts/evaluation/pairwise-comparison-prompt
---
...
1. **Criterion by Criterion**: Don't jump to overall conclusion
1. **Justify Before Decide**: Explain reasoning before stating winner
1. **Acknowledge Tradeoffs**: Note when responses excel in different areas
1. **Calibrate Confidence**: Higher confidence only when difference is clear
