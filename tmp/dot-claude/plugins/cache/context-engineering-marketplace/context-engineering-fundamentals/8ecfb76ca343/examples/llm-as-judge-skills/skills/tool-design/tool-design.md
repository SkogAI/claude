...
title: tool-design
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/skills/tool-design/tool-design
---
...
1. **Comprehensive Descriptions**: Include usage examples in tool descriptions
1. **Reasonable Defaults**: Provide sensible defaults for optional parameters
1. **Idempotency**: Design tools to be safely re-executable when possible
1. **Timeout Handling**: Implement timeouts for external operations
1. **Rate Limiting**: Protect against runaway tool execution
1. **Logging**: Log all tool invocations for debugging and audit
