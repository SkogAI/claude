...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/x-to-book-system/skills-mapping
---
...
1. **Peer-to-Peer/Swarm**: "When to use: Tasks requiring flexible exploration, tasks where rigid planning is counterproductive."
1. **Hierarchical**: "When to use: Large-scale projects with clear hierarchical structure."
...
1. Analyzer reads from file system, produces summaries
1. Summaries (not raw data) flow to subsequent phases
