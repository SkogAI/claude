---
title: direct-scoring-prompt
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/prompts/evaluation/direct-scoring-prompt
---
...
1. **Rubric Alignment**: Stick to rubric definitions, don't interpolate
1. **Constructive Feedback**: Make improvement suggestions actionable
1. **Consistency**: Apply same standards across evaluations
1. **Calibration**: Use example evaluations for reference
