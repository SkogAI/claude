...
title: index
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/llm-as-judge-skills/agents/index
---
...
1. Create main file: `agents/<agent-name>/<agent-name>.md`
1. Define:
   - Purpose and role
   - System instructions
   - Tool assignments
   ...
   - Usage examples
1. Update this index
1. Register with orchestrator if applicable
