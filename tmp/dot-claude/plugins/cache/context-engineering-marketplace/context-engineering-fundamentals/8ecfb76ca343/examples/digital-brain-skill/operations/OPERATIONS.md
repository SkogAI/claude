...
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/examples/digital-brain-skill/operations/operations
---
...
1. Check metrics in metrics.jsonl
1. Plan next week's priorities
1. Update goals.yaml progress

### Goal Setting (Quarterly)

1. Review previous quarter goals
1. Update goals.yaml with new OKRs
1. Break down into monthly targets
1. Align content calendar with goals
...
1. **Goals**: Reference before major decisions or planning
1. **Meetings**: Log immediately after with key takeaways
1. **Metrics**: Update at least weekly
1. **Reviews**: Generate insights, not just summaries
...
1. Review existing todos.md capacity
1. Consider time-sensitivity and dependencies
1. Suggest realistic timelines </instructions>
