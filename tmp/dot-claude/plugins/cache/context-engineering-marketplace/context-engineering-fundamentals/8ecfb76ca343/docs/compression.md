...
doc_type: research
source_url: false
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/docs/compression
---
...
1. Examine the response for evidence
1. Assign a score from 0-5 based on the scoring guide
1. Provide brief reasoning for your score
