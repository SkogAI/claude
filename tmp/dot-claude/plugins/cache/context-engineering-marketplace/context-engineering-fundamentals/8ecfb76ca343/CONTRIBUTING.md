...
title: CONTRIBUTING
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/contributing
---
...
1. Make changes following the skill template structure
1. Ensure SKILL.md files remain under 500 lines
1. Add references or scripts as appropriate
...
1. Include both SKILL.md and appropriate references/scripts
1. Update the root README.md to include the new skill
1. Ensure content is platform-agnostic (works across Cursor, Claude Code, etc.)
