...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/advanced-evaluation/references/implementation-patterns
---
...
1. **Prompt presence**: Original prompt for context
1. **Criteria validity**: At least one criterion with name and description
1. **Weight normalization**: Weights sum to 1.0 (or normalize them)
