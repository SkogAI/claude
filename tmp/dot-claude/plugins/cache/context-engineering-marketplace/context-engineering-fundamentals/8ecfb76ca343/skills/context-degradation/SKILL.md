...
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/context-degradation/skill
---
...
1. Place critical information at beginning or end of context
1. Implement compaction triggers before degradation becomes severe
1. Validate retrieved documents for accuracy before adding to context
1. Use versioning to prevent outdated information from causing clash
1. Segment tasks to prevent context confusion across different objectives
1. Design for graceful degradation rather than assuming perfect conditions
1. Test with progressively larger contexts to find degradation thresholds
