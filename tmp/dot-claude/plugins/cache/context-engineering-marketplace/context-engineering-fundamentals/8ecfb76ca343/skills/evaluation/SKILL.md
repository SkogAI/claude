...
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/evaluation/skill
---
...
1. Create rubrics with clear, actionable level descriptions
1. Build test sets from real usage patterns and edge cases
1. Implement automated evaluation pipelines
1. Establish baseline metrics before making changes
1. Run evaluations on all significant changes
1. Track metrics over time for trend analysis
1. Supplement automated evaluation with human review
...
1. Evaluate outcomes, not specific execution paths
1. Cover complexity levels from simple to complex
1. Test with realistic context sizes and histories
1. Run evaluations continuously, not just before release
1. Supplement LLM evaluation with human review
1. Track metrics over time for trend detection
1. Set clear pass/fail thresholds based on use case
