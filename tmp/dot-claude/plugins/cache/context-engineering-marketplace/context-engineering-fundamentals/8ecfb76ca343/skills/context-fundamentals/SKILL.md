...
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/context-fundamentals/skill
---
...
1. Place critical information at attention-favored positions (beginning and end)
1. Use progressive disclosure to defer loading until needed
1. Organize system prompts with clear section boundaries
1. Monitor context usage during development
1. Implement compaction triggers at 70-80% utilization
1. Design for context degradation rather than hoping to avoid it
1. Prefer smaller high-signal context over larger low-signal context
