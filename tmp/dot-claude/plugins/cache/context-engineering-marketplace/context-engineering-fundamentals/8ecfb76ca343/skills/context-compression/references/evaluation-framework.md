...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/context-compression/references/evaluation-framework
---
...
1. **Context awareness gap**: 0.45 points, favoring anchored iterative
1. **Artifact trail**: Universally weak (2.19-2.45), needs specialized handling
1. **Completeness and instruction following**: Minimal differentiation
...
1. Extract file operations for artifact probes
1. Extract incomplete tasks for continuation probes
1. Extract decision points for decision probes

### Grading Process

1. Feed probe question + model response + compressed context to judge
1. Evaluate against each criterion in rubric
1. Output structured JSON with scores and reasoning
1. Compute dimension scores as weighted averages
1. Compute overall score as unweighted average of dimensions
