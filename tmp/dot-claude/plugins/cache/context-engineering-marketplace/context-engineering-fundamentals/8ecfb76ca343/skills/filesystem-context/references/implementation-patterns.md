...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/filesystem-context/references/implementation-patterns
---
...
1. **Dynamic load rate**: how often skills/files are loaded per task
1. **Offload savings**: tokens saved by writing to files vs keeping in context
1. **Retrieval precision**: percentage of loaded content actually used
