...
title: metrics-guide
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/advanced-evaluation/references/metrics-guide
---
...
1. Secondary: Per-criterion agreement
1. Diagnostic: Confusion matrix for systematic errors
...
1. Secondary: Position consistency (bias check)
1. Diagnostic: Per-criterion breakdown
...
1. Secondary: Score distribution stability
1. Diagnostic: Bias indicators (position, length)
...
1. **Low position consistency**: Position bias affecting results
1. **High length correlation**: Length bias inflating scores
1. **Per-criterion variance**: Some criteria may be poorly defined
