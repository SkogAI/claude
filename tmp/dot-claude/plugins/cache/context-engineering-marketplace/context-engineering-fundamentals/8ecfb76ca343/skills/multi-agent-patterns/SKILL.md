...
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/multi-agent-patterns/skill
---
...
1. Choose architecture pattern based on coordination needs, not organizational metaphor
1. Implement explicit handoff protocols with state passing
1. Use weighted voting or debate protocols for consensus
1. Monitor for supervisor bottlenecks and implement checkpointing
1. Validate outputs before passing between agents
1. Set time-to-live limits to prevent infinite loops
