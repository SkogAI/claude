...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/tool-design/references/best-practices
---
...
1. Have an agent formulate tool calls for each request
1. Evaluate call correctness against expected patterns
1. Identify common failure modes
1. Refine tool definitions based on findings
