...
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/skills/context-optimization/skill
---
...
1. Apply compaction before masking when possible
1. Design for cache stability with consistent prompts
1. Partition before context becomes problematic
1. Monitor optimization effectiveness over time
1. Balance token savings against quality preservation
1. Test optimization at production scale
1. Implement graceful degradation for edge cases
