...
title: README
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/context-engineering-fundamentals/8ecfb76ca343/readme
---
...
1. Choose a plugin (e.g., `context-engineering-fundamentals`, `agent-architecture`)
