...
title: intros
type: note
permalink: claude/tmp/dot-claude/plugins/cache/context-engineering-marketplace/cognitive-architecture/8ecfb76ca343/examples/digital-brain-skill/network/intros
---
...
| ------------- | ------------- | ----------------------------- | -------------- | ----------- |
| [PLACEHOLDER] | [PLACEHOLDER] | [PLACEHOLDER: Why this intro] | \`to_reach_out | reached_out |
...
| ------------- | ------------- | -------------------- | -------- |
| [PLACEHOLDER] | [PLACEHOLDER] | [PLACEHOLDER]        | \`to_ask |
