...
title: README
type: note
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/feature-dev/55b58ec6e564/readme
---
...
1. **Answer clarifying questions thoughtfully**: Phase 3 prevents future confusion
1. **Choose architecture deliberately**: Phase 4 gives you options for a reason
1. **Don't skip code review**: Phase 6 catches issues before they reach production
1. **Read the suggested files**: Phase 2 identifies key files—read them to understand context
