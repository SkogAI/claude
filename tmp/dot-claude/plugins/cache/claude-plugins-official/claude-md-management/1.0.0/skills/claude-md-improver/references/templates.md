...
title: templates
type: note
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/claude-md-management/1.0.0/skills/claude-md-improver/references/templates
---
...
1. **Be current**: Verify info against the actual codebase
1. **Be brief**: One line per concept when possible
1. **Be useful**: Would this help a new Claude session understand the project?
