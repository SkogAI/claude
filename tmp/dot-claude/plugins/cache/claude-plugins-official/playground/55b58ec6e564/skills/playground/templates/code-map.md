...
title: code-map
type: note
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/playground/55b58ec6e564/skills/playground/templates/code-map
---
...
1. **Save comment** → Add to comments list, mark node with visual indicator (colored border)
1. **View comments** → Sidebar list with component name, comment preview, delete button
1. **Delete comment** → Remove from list, update node visual, regenerate prompt
