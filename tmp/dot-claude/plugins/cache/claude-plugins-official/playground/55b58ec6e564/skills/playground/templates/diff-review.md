...
title: diff-review
type: note
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/playground/55b58ec6e564/skills/playground/templates/diff-review
---
...
1. Parse the output into the `diffData` structure
1. Include commit metadata in the header section
