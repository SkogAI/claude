...
type: note
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/playground/55b58ec6e564/skills/playground/templates/document-critique
---
...
1. Analyze and generate suggestions with:
   - Specific line references
   - Clear, actionable suggestion text
   - Category tags (clarity, completeness, performance, accessibility, ux)
1. Embed both the document content and suggestions array in the HTML
