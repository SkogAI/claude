...
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/playground/55b58ec6e564/skills/playground/skill
---
...
1. **Load the matching template** from `templates/`:
...
1. **Follow the template** to build the playground. If the topic doesn't fit any template cleanly, use the one closest and adapt.
1. **Open in browser.** After writing the HTML file, run `open <filename>.html` to launch it in the user's default browser.
