...
title: README
type: note
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/hookify/55b58ec6e564/readme
---
...
1. Rules should work immediately - no restart needed
1. Try `/hookify:list` to see if rule is loaded
