...
allowed-tools:
  - Read
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/hookify/55b58ec6e564/commands/help
---
...
1. Refine the rule by editing `.claude/hookify.warn-rm.local.md`
