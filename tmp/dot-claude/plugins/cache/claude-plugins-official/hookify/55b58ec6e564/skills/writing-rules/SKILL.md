...
version: 0.1.0
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/hookify/55b58ec6e564/skills/writing-rules/skill
---
...
1. Create `.claude/hookify.{name}.local.md` file in project root
1. Test immediately - rules are read dynamically on next tool use

### Refining a Rule

1. Edit the `.local.md` file
1. Adjust pattern or message
1. Test immediately - changes take effect on next tool use
