...
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/code-review/55b58ec6e564/commands/code-review
---
...
1. Use a Haiku agent to view the pull request, and ask the agent to return a summary of the change
...
1. Filter out any issues with a score less than 80. If there are no issues that meet this criteria, do not proceed.
1. Use a Haiku agent to repeat the eligibility check from #1, to make sure that the pull request is still eligible for code review.
1. Finally, use the gh bash command to comment back on the pull request with the result. When writing your comment, keep in mind to: a. Keep your output brief b. Avoid emojis c. Link and cite relevant code, files, and URLs
