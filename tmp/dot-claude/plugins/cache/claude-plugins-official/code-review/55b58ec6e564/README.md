...
title: README
type: note
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/code-review/55b58ec6e564/readme
---
...
1. Gathers relevant CLAUDE.md guideline files from the repository
1. Summarizes the pull request changes
1. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for CLAUDE.md compliance
   - **Agent #3**: Scan for obvious bugs in changes
   - **Agent #4**: Analyze git blame/history for context-based issues
1. Scores each issue 0-100 for confidence level
1. Filters out issues below 80 confidence threshold
1. Posts review comment with high-confidence issues only
