...
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/slack/08dd8db7f420/skills/slack-search/skill
---
...
1. If too many results, add filters (`in:`, `from:`, date ranges).
1. If too few results, remove filters and try synonyms or related terms.
