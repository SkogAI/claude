...
title: mcp-servers
type: note
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/claude-code-setup/1.0.0/skills/claude-automation-recommender/references/mcp-servers
---
...
1. **Global config** (`~/.claude.json`) - Available across all projects
1. **Checked-in `.mcp.json`** - Available to entire team (recommended!)
