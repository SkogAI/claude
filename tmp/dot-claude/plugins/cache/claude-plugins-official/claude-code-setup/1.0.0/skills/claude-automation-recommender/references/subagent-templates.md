---
title: subagent-templates
type: note
permalink: claude/tmp/dot-claude/plugins/cache/claude-plugins-official/claude-code-setup/1.0.0/skills/claude-automation-recommender/references/subagent-templates
---
