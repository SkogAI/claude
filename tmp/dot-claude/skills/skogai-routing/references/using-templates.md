...
type: note
permalink: claude/tmp/dot-claude/skills/skogai-routing/references/using-templates
---
...
1. Placeholder indicators (use `{{placeholder}}` or `[PLACEHOLDER]`)
1. Inline guidance for what goes where
1. Example content where helpful \</template_structure>
