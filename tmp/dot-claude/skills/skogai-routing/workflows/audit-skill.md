...
title: audit-skill
type: note
permalink: claude/tmp/dot-claude/skills/skogai-routing/workflows/audit-skill
---
...
1. **Fix one by one** - Review each fix before applying
1. **Just the report** - No changes needed

If fixing:

- Make each change
- Verify file validity after each change
- Report what was fixed </process>
