...
title: get-guidance
type: note
permalink: claude/tmp/dot-claude/skills/skogai-routing/workflows/get-guidance
---
...
1. references/recommended-structure.md \</required_reading>
...
If yes → offer to switch to "Create a new skill" workflow If no → clarify and iterate </process>
...
\<success_criteria> Guidance is complete when:
...
- [ ] User is ready to build (or decided not to) \</success_criteria>
