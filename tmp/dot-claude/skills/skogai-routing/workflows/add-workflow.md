...
title: add-workflow
type: note
permalink: claude/tmp/dot-claude/skills/skogai-routing/workflows/add-workflow
---
...
1. references/workflows-and-validation.md \</required_reading>
...
1. Move existing process content to workflows/main.md
1. Rewrite SKILL.md as router with intake + routing
1. Verify structure works before proceeding
...
1. **Routing table** - Map option to workflow file
1. **Workflows index** - Add to the list
...
1. Add to reference_index in SKILL.md
1. Reference it in the workflow's required_reading
...
Report results to user. </process>
