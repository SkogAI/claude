---
title: refactoring-to-prompt-native
type: note
permalink: claude/tmp/dot-claude/skills/skogai-agent-prompting/references/refactoring-to-prompt-native
---
...
- [ ] New features could be added without new tools </checklist>
