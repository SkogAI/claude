---
title: agent-native-testing
type: note
permalink: claude/tmp/dot-claude/skills/skogai-agent-prompting/references/agent-native-testing
---
...
- [ ] Capability map drift detection </checklist>
