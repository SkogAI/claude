---
title: action-parity-discipline
type: note
permalink: claude/tmp/dot-claude/skills/skogai-agent-prompting/references/action-parity-discipline
---
...
- Users lose trust in the agent's capabilities \</why_parity>
...
- 🚫 N/A: User-only action (e.g., biometric auth, camera capture) \</capability_mapping>
...
- Theme changes
- Account deletion
- Settings that are UI-preference \</parity_audit>
...
- [ ] Can the agent access the same level of detail? \</context_parity>
...
- [ ] Created issues for high-priority gaps </checklist>
