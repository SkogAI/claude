...
type: note
permalink: claude/tmp/dot-claude/projects/home-skogix-dev-agent-skills-for-context-engineering/memory/context-philosophy
---
...
Standard approach: accumulate knowledge, optimize retrieval. SkogAI approach: delete everything inferrable, keep only the delta.
