...
Message-ID: <SkogAI/skoglib/pull/47/c3359455693@github.com>
In-Reply-To: <SkogAI/skoglib/pull/47@github.com>
References: <SkogAI/skoglib/pull/47@github.com>
Content-Type: multipart/alternative; boundary="--==_mimepart_68de229af075d_608610d822147"; charset="UTF-8"

github-actions[bot] left a comment (SkogAI/skoglib#47)

🤖 I'm sorry @Skogix, but I was unable to process your request. Please [see the logs](https://github.com/SkogAI/skoglib/actions/runs/18185755048) for more details.

-- 
Reply to this email directly or view it on GitHub:
https://github.com/SkogAI/skoglib/pull/47#issuecomment-3359455693
