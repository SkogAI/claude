MIME-Version: 1.0
From: larhlimiAbd <notifications@github.com>
To: actions/starter-workflows <starter-workflows@noreply.github.com>
Date: Mon, 27 Oct 2025 04:33:39 -0700
Subject: [actions/starter-workflows] Add GitHub Actions workflow for Hello World (PR #3095)
Message-ID: <actions/starter-workflows/pull/3095@github.com>
Content-Type: multipart/alternative; boundary="--==_mimepart_68ff5893a66ad_cf1100976a0"; charset="UTF-8"
...
You can view, comment on, or merge this pull request online at:
  ...
  https://github.com/actions/starter-workflows/pull/3095
...
-- File Changes --
    ...
    A automation/hello.yml (13)

-- Patch Links --

https://github.com/actions/starter-workflows/pull/3095.patch
https://github.com/actions/starter-workflows/pull/3095.diff
