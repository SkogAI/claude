...
**Source**: [Github #11](https://github.com/SkogAI/dot-skogai/issues/11)
...
- `always_load` — files that are always relevant (e.g. `memory/context/current.md`)
- `content_creation` — how to use templates
- `commands` — common bootstrap/usage commands
